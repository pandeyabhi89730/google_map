...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
            ...
            ibsend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!isExistingPoint){
                        ...
                        meta.put("name",getIntent().getStringExtra("types"));
                        meta.put("updated",new Date().toString());

                        Backendless.Geo.savePoint(lat, lng, category, meta, new AsyncCallback<GeoPoint>() {
                            @Override
                        ...
                        Backendless.Geo.removePoint(existpoint, new AsyncCallback<Void>() {
                            @Override
    ...
    protected void onResume() {
        ...
        {
            locationManager.requestLocationUpdates(provider,100000,50,this);
